...
input_folder = '/media/sdc/wpguan/BasicSR_datasets/RNI15/';
%%%%%%%%%%%%%%%%%%%%% save_mod_folder = '';
save_LR_folder = '/media/sdc/wpguan/BasicSR_datasets/RNI15_blur_0.5_10';
%%%%%%%%%%%%%5% save_bic_folder = '';
%save_residual_folder='/media/sdc/wpguan/BasicSR_datasets/RNI15_blur_residual_0.5_10'%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
