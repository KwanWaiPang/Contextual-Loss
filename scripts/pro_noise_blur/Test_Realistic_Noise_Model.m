...
input_folder = '/media/sdc/wpguan/BasicSR_datasets/CRF/Set5/';
%%%%%%%%%%%%%%%%%%%%% save_mod_folder = '';
save_LR_folder = '/media/sdc/wpguan/BasicSR_datasets/CRF/Set5_noise_s0.30_c0.13';
%%%%%%%%%%%%%5% save_bic_folder = '';
save_residual_folder= '/media/sdc/wpguan/BasicSR_datasets/CRF/Set5_noise_s0.30_c0.13';
...
if nargin < 2
    rng('shuffle');
    sigma_s = 0.30*rand(1,channel,'single'); % original 0.16 cheng
    % sigma_s=[0.08,0.08,0.08];
    rng('shuffle');
    sigma_c = 0.13*rand(1,channel,'single'); % original 0.06  jia
    % sigma_c=[0.03,0.03,0.03];
